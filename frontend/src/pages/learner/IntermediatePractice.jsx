...
import { ArrowLeft, Layers, Sparkles, BookOpen, Clock, Target, CheckCircle2, Video } from 'lucide-react';

export const IntermediatePractice = () => {
  return (
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Word formation, compound gestures & dynamic sign sequences
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 glass-card p-6 sm:p-8 rounded-3xl border border-slate-800/80 bg-slate-900/60 shadow-xl space-y-6">
          <div className="flex items-center justify-between border-b border-slate-800 pb-4">
            <div>
              <h2 className="text-lg font-extrabold text-white">
                Intermediate Practice Module
              </h2>
              <p className="text-xs text-slate-400 mt-0.5">
                Multi-sign combination & transition flow
              </p>
            </div>
          ...
          <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-3">
            <h3 className="text-sm font-bold text-indigo-300 flex items-center gap-2">
              <Sparkles className="w-4 h-4" /> Next-Generation Practice Module Integration
            </h3>
            <p className="text-xs text-slate-300 leading-relaxed">
              Intermediate practice builds on your alphabet foundations by introducing multi-sign vocabulary drills, common conversational expressions, and dynamic transition timing.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-xs">
                <span className="font-bold text-white block">Compound Gestures</span>
                <span className="text-slate-400 text-[11px]">Combining two-hand spatial configurations</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-xs">
                <span className="font-bold text-white block">Speed & Transition</span>
                <span className="text-slate-400 text-[11px]">Timing analysis between consecutive signs</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-indigo-950/20 border border-indigo-500/20 space-y-3">
            ...
            <p className="text-xs text-slate-300">
              While new intermediate vocabulary gesture sets are being packaged, reinforce your foundations in Beginner Mode with alphabet recognition or review lesson curricula.
            </p>
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              >
                <BookOpen className="w-3.5 h-3.5 text-indigo-400" /> Explore Intermediate Lessons
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="glass-card p-6 rounded-3xl border border-slate-800/80 bg-slate-900/60 shadow-xl space-y-4">
            <h3 className="text-sm font-bold text-white flex items-center gap-2">
              <Target className="w-4 h-4 text-indigo-400" /> Learning Objectives
            </h3>
            <ul className="space-y-2.5 text-xs text-slate-300">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-indigo-400 mt-0.5 shrink-0" />
                <span>Recognize and reproduce common two-handed signs</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-indigo-400 mt-0.5 shrink-0" />
                <span>Maintain posture consistency across transitions</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-indigo-400 mt-0.5 shrink-0" />
                <span>Achieve sustained recognition confidence above 85%</span>
              </li>
            </ul>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 text-xs space-y-1 text-slate-400">
            <div className="flex justify-between">
              ...
              <span className="text-indigo-300 font-bold">Intermediate</span>
            </div>
            <div className="flex justify-between">
              <span>Status:</span>
